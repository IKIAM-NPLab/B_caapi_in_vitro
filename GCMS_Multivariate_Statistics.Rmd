...
mass_norm_noBlank <- mass_norm[, colnames(mass_norm) != "ID_4"]

# Transponer para PCA 
mass_norm_t <- t(mass_norm_noBlank)
...
# Eliminar la columna del blanco (ID_4)
is_mass_norm_noBlank <- is_mass_norm[, colnames(is_mass_norm) != "ID_4"]

# Transponer para PCA 
is_mass_norm_t <- t(is_mass_norm_noBlank)
